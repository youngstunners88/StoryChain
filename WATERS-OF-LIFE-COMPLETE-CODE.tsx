...
export default function WatersOfLife() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img src="/watersoflife/9-logo.jpg" alt="Waters Of Life" className="h-10 w-10 rounded-full object-cover" />
      ...
      {/* Hero Section - Image 2: Food Collage */}
      <header className="pt-20 relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <img 
          src="/watersoflife/2-food-collage.jpg" 
          alt="Waters Of Life" 
      ...
      {/* About Section - Image 3: Chef Community */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Waters Of Life is a passion-driven street food business founded by Chef Ntokozo Mkhize. 
                Our journey began with a simple belief: good food nourishes not just the body, but the soul.
              </p>
              <p className="text-gray-600 mb-4">
                Based in Maboneng, Johannesburg, we serve authentic South African street food with a focus on 
                quality, community, and sustainability. Our "mind • body • soil" philosophy guides everything we do.
              </p>
              <p className="text-gray-600 mb-6">
                From the Meatless Monday movement to community events, we're committed to making a positive 
                impact through food.
              </p>
            ...
            <div className="relative">
              <img 
                src="/watersoflife/3-chef-community.jpg" 
                alt="Chef Ntokozo with community" 
      ...
      <section id="menu" className="py-20 px-4 bg-gradient-to-br from-amber-600 to-orange-500 text-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="bg-white rounded-2xl p-4 shadow-2xl max-w-2xl mx-auto">
            <img 
              src="/watersoflife/7-menu-poster.jpg" 
      ...
      {/* Gallery Section - ALL 9 IMAGES, NO DUPLICATES */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/1-fao-booth.jpg" alt="FAO Partnership" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                <span className="text-white font-semibold">FAO Partnership</span>
              </div>
            </div>
            {/* Image 4: Banner 1 */}
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/4-banner1.jpg" alt="Our Banner" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                <span className="text-white font-semibold">Our Banner</span>
              </div>
            </div>
            {/* Image 5: Banner 2 */}
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/5-banner2.jpg" alt="Our Brand" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                <span className="text-white font-semibold">Our Brand</span>
              </div>
            </div>
            {/* Image 6: App Menu */}
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/6-app-menu.jpg" alt="Mobile App" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                <span className="text-white font-semibold">Mobile App</span>
              </div>
            </div>
            {/* Image 8: Event Poster */}
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/8-event-poster.jpg" alt="Events" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
            ...
            {/* Image 9: Logo */}
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/9-logo.jpg" alt="Our Logo" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                <span className="text-white font-semibold">Our Logo</span>
              </div>
            </div>
            {/* Images 2 and 3 already used in Hero and About sections */}
            {/* Image 7 used in Menu section */}
          </div>
        </div>
      </section>

      {/* Events Section - Image 8 already shown in gallery */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-auto">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-2xl font-bold">Music, Games & Food</h3>
            </div>
            <p className="text-xl mb-4">11 September | R150 per person</p>
            <ul className="space-y-2 mb-6">
              <li>✦ Saxophone performances</li>
              <li>✦ Traditional dance</li>
              <li>✦ Board games, chess & cards</li>
              <li>✦ 11AM arrival | 12PM starters | 1PM main course</li>
            </ul>
            <a href="tel:0719400506" className="inline-block bg-white text-purple-600 px-8 py-3 rounded-full font-semibold hover:bg-purple-100 transition-colors">
              RSVP: 071 940 0506
            </a>
          </div>
        </div>
