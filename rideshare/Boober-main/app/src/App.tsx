...
const App: React.FC = () => {
  ...
  const [suggestions, setSuggestions] = useState<Suggestion[]>([
    { id: '1', userId: 'system', userName: 'Boober Bot', content: 'We need a dark mode for night trips!', type: 'IMPROVE', timestamp: Date.now() }
  ]);
  ...
  const [posts, setPosts] = useState<SocialPost[]>([
    {
      ...
      likes: 24,
      likedBy: [],
      replies: [{ id: 'r1', author: 'Boober Bot', authorId: 'bot', content: 'Sharp! Keep it moving, Boss.', timestamp: Date.now() - 1500000 }]
    }
  ]);
