import { Phone, Instagram, Facebook, MapPin, ChevronDown } from "lucide-react";
...
export default function WatersOfLife() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-orange-50">
      ...
      {/* About - IMAGES 05 & 04: Banner & Chef BW */}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
            <div>
              ...
              <p className="text-gray-600 mb-6">Our "mind • body • soil" philosophy guides everything we do.</p>
              <div className="flex gap-4">
                <div className="bg-amber-100 p-4 rounded-lg text-center"><p className="text-2xl font-bold text-amber-600">Since</p><p className="text-gray-700">2005</p></div>
                <div className="bg-amber-100 p-4 rounded-lg text-center"><p className="text-2xl font-bold text-amber-600">Location</p><p className="text-gray-700">Maboneng</p></div>
              </div>
            </div>
            <div><img src="/watersoflife/05-banner.jpg" alt="Waters Of Life Banner" className="rounded-2xl shadow-2xl w-full" /></div>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div><img src="/watersoflife/04-chef-bw.jpg" alt="Chef Ntokozo" className="rounded-2xl shadow-2xl w-full" /></div>
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-4">Chef Ntokozo Mkhize</h3>
              <p className="text-gray-600 mb-4">Passionate about creating delicious, healthy food that nourishes both body and soul.</p>
      ...
      {/* Gallery - IMAGES 01, 03, 06: FAO Booth, Chef with children, App Menu */}
      <section id="gallery" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/03-chef-children.jpg" alt="Community" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4"><span className="text-white font-semibold">Community Events</span></div>
            </div>
            <div className="relative group overflow-hidden rounded-xl aspect-square">
              <img src="/watersoflife/06-app-menu.jpg" alt="Our Menu" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
      ...
      {/* Events - IMAGE 09: Event poster */}
      <section id="events" className="py-20 px-4 bg-gradient-to-br from-purple-600 to-pink-500 text-white">
        <div className="max-w-6xl mx-auto">
