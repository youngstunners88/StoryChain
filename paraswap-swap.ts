...
async function main() {
  ...
  if (BigInt(currentAllowance as bigint) < amountIn) {
    const approveTx = await walletClient.writeContract({
      address: USDC,
      abi: ERC20_ABI,
      functionName: 'approve',
      args: [PARASWAP_PROXY, BigInt('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff')], // Max approval
    });
